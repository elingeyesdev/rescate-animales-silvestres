...
<head>
    ...
    {{-- Favicon --}}
    <link rel="icon" type="image/svg+xml" href="{{ asset('images/paw-primary.svg') }}">
    <link rel="shortcut icon" href="{{ asset('images/paw-primary.svg') }}">
...
<body class="@yield('classes_body')" @yield('body_data')>
    ...
    @else
        @switch(config('adminlte.laravel_asset_bundling', false))
            ...
            @case('vite')
                {{-- Scripts are already loaded via @vite directive in the head --}}
            @break
