										...
										<td >{{ $treatmentType->nombre }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('treatment-types.destroy', $treatmentType->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('treatment-types.show', $treatmentType->id) }}"><i class="fa fa-fw fa-eye"></i> <span class="d-none d-md-inline">{{ __('Ver') }}</span></a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('treatment-types.edit', $treatmentType->id) }}"><i class="fa fa-fw fa-edit"></i> <span class="d-none d-md-inline">{{ __('Editar') }}</span></a>
                                                    @csrf
                                                    @method('DELETE')
