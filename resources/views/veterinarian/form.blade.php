<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="cv_documentado" class="form-control @error('cv_documentado') is-invalid @enderror" value="{{ old('cv_documentado', $veterinarian?->cv_documentado) }}" id="cv_documentado" placeholder="Cv Documentado">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="persona_id" class="form-control @error('persona_id') is-invalid @enderror" value="{{ old('persona_id', $veterinarian?->persona_id) }}" id="persona_id" placeholder="Persona Id">
